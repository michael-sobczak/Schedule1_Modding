internal struct XCrossingEvent // TypeDefIndex: 5732
{
	// Fields
	...
	internal NotifyMode mode; // 0x50
	internal NotifyDetail detail; // 0x54
	internal bool same_screen; // 0x58
	internal bool focus; // 0x59
	internal int state; // 0x5C
}
