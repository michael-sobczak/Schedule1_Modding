public struct int4 : IEquatable<int4>, IFormattable // TypeDefIndex: 10932
{
	// Fields
	public int x; // 0x0
	public int y; // 0x4
	...
	// RVA: 0x28EA010 Offset: 0x28E8A10 VA: 0x1828EA010
	public void .ctor(int x, int y, int2 zw) { }

	// RVA: 0x28E9FF0 Offset: 0x28E89F0 VA: 0x1828E9FF0
	public void .ctor(int x, int2 yz, int w) { }

	// RVA: 0x28E9F80 Offset: 0x28E8980 VA: 0x1828E9F80
	public void .ctor(int x, int3 yzw) { }

	// RVA: 0x28E9F60 Offset: 0x28E8960 VA: 0x1828E9F60
	public void .ctor(int2 xy, int z, int w) { }

	// RVA: 0x214D480 Offset: 0x214BE80 VA: 0x18214D480
	public void .ctor(int2 xy, int2 zw) { }

	// RVA: 0x28E9EF0 Offset: 0x28E88F0 VA: 0x1828E9EF0
	public void .ctor(int3 xyz, int w) { }

	// RVA: 0x22D2A70 Offset: 0x22D1470 VA: 0x1822D2A70
	public void .ctor(int4 xyzw) { }

	// RVA: 0x28E9E70 Offset: 0x28E8870 VA: 0x1828E9E70
	public void .ctor(int v) { }

	// RVA: 0x28EA030 Offset: 0x28E8A30 VA: 0x1828EA030
	public void .ctor(bool v) { }

	// RVA: 0x28E9FA0 Offset: 0x28E89A0 VA: 0x1828E9FA0
	...
	// RVA: 0x2967320 Offset: 0x2965D20 VA: 0x182967320
	public void .ctor(float v) { }

	// RVA: 0x2967380 Offset: 0x2965D80 VA: 0x182967380
	public void .ctor(float4 v) { }

	// RVA: 0x2967340 Offset: 0x2965D40 VA: 0x182967340
	public void .ctor(double v) { }

	// RVA: 0x2967360 Offset: 0x2965D60 VA: 0x182967360
	public void .ctor(double4 v) { }

	// RVA: 0x2714F50 Offset: 0x2713950 VA: 0x182714F50
	public static int4 op_Implicit(int v) { }

	// RVA: 0x28A90F0 Offset: 0x28A7AF0 VA: 0x1828A90F0
	public static int4 op_Explicit(bool v) { }

	// RVA: 0x28A9150 Offset: 0x28A7B50 VA: 0x1828A9150
	public static int4 op_Explicit(bool4 v) { }

	// RVA: 0x2714F50 Offset: 0x2713950 VA: 0x182714F50
	public static int4 op_Explicit(uint v) { }

	// RVA: 0x28A90C0 Offset: 0x28A7AC0 VA: 0x1828A90C0
	public static int4 op_Explicit(uint4 v) { }

	// RVA: 0x28A91F0 Offset: 0x28A7BF0 VA: 0x1828A91F0
	public static int4 op_Explicit(float v) { }

	// RVA: 0x28A92B0 Offset: 0x28A7CB0 VA: 0x1828A92B0
	public static int4 op_Explicit(float4 v) { }

	// RVA: 0x28A91D0 Offset: 0x28A7BD0 VA: 0x1828A91D0
	public static int4 op_Explicit(double v) { }

	// RVA: 0x28A91A0 Offset: 0x28A7BA0 VA: 0x1828A91A0
	public static int4 op_Explicit(double4 v) { }

	// RVA: 0x28ED130 Offset: 0x28EBB30 VA: 0x1828ED130
	public static int4 op_Multiply(int4 lhs, int4 rhs) { }

	// RVA: 0x28ED100 Offset: 0x28EBB00 VA: 0x1828ED100
	public static int4 op_Multiply(int4 lhs, int rhs) { }

	// RVA: 0x28ED160 Offset: 0x28EBB60 VA: 0x1828ED160
	public static int4 op_Multiply(int lhs, int4 rhs) { }

	// RVA: 0x2712B70 Offset: 0x2711570 VA: 0x182712B70
	public static int4 op_Addition(int4 lhs, int4 rhs) { }

	// RVA: 0x28EC9E0 Offset: 0x28EB3E0 VA: 0x1828EC9E0
	public static int4 op_Addition(int4 lhs, int rhs) { }

	// RVA: 0x28ECA10 Offset: 0x28EB410 VA: 0x1828ECA10
	public static int4 op_Addition(int lhs, int4 rhs) { }

	// RVA: 0x28ED260 Offset: 0x28EBC60 VA: 0x1828ED260
	public static int4 op_Subtraction(int4 lhs, int4 rhs) { }

	// RVA: 0x28ED230 Offset: 0x28EBC30 VA: 0x1828ED230
	public static int4 op_Subtraction(int4 lhs, int rhs) { }

	// RVA: 0x28ED200 Offset: 0x28EBC00 VA: 0x1828ED200
	public static int4 op_Subtraction(int lhs, int4 rhs) { }

	// RVA: 0x2967390 Offset: 0x2965D90 VA: 0x182967390
	public static int4 op_Division(int4 lhs, int4 rhs) { }

	// RVA: 0x2967400 Offset: 0x2965E00 VA: 0x182967400
	public static int4 op_Division(int4 lhs, int rhs) { }

	// RVA: 0x29673D0 Offset: 0x2965DD0 VA: 0x1829673D0
	public static int4 op_Division(int lhs, int4 rhs) { }

	// RVA: 0x29676A0 Offset: 0x29660A0 VA: 0x1829676A0
	public static int4 op_Modulus(int4 lhs, int4 rhs) { }

	// RVA: 0x29676E0 Offset: 0x29660E0 VA: 0x1829676E0
	public static int4 op_Modulus(int4 lhs, int rhs) { }

	// RVA: 0x2967670 Offset: 0x2966070 VA: 0x182967670
	public static int4 op_Modulus(int lhs, int4 rhs) { }

	// RVA: 0x28ECE30 Offset: 0x28EB830 VA: 0x1828ECE30
	public static int4 op_Increment(int4 val) { }

	// RVA: 0x28ECB30 Offset: 0x28EB530 VA: 0x1828ECB30
	public static int4 op_Decrement(int4 val) { }

	// RVA: 0x2967610 Offset: 0x2966010 VA: 0x182967610
	public static bool4 op_LessThan(int4 lhs, int4 rhs) { }

	// RVA: 0x2967640 Offset: 0x2966040 VA: 0x182967640
	public static bool4 op_LessThan(int4 lhs, int rhs) { }

	// RVA: 0x29675E0 Offset: 0x2965FE0 VA: 0x1829675E0
	public static bool4 op_LessThan(int lhs, int4 rhs) { }

	// RVA: 0x2967580 Offset: 0x2965F80 VA: 0x182967580
	public static bool4 op_LessThanOrEqual(int4 lhs, int4 rhs) { }

	// RVA: 0x29675B0 Offset: 0x2965FB0 VA: 0x1829675B0
	public static bool4 op_LessThanOrEqual(int4 lhs, int rhs) { }

	// RVA: 0x2967550 Offset: 0x2965F50 VA: 0x182967550
	public static bool4 op_LessThanOrEqual(int lhs, int4 rhs) { }

	// RVA: 0x2967520 Offset: 0x2965F20 VA: 0x182967520
	public static bool4 op_GreaterThan(int4 lhs, int4 rhs) { }

	// RVA: 0x29674C0 Offset: 0x2965EC0 VA: 0x1829674C0
	public static bool4 op_GreaterThan(int4 lhs, int rhs) { }

	// RVA: 0x29674F0 Offset: 0x2965EF0 VA: 0x1829674F0
	public static bool4 op_GreaterThan(int lhs, int4 rhs) { }

	// RVA: 0x2967490 Offset: 0x2965E90 VA: 0x182967490
	public static bool4 op_GreaterThanOrEqual(int4 lhs, int4 rhs) { }

	// RVA: 0x2967430 Offset: 0x2965E30 VA: 0x182967430
	public static bool4 op_GreaterThanOrEqual(int4 lhs, int rhs) { }

	// RVA: 0x2967460 Offset: 0x2965E60 VA: 0x182967460
	public static bool4 op_GreaterThanOrEqual(int lhs, int4 rhs) { }

	// RVA: 0x28ED290 Offset: 0x28EBC90 VA: 0x1828ED290
	...
	// RVA: 0x28ED560 Offset: 0x28EBF60 VA: 0x1828ED560
	public void set_xz(int2 value) { }

	// RVA: 0x28EAB80 Offset: 0x28E9580 VA: 0x1828EAB80
	public int2 get_xw() { }

	// RVA: 0x28ED470 Offset: 0x28EBE70 VA: 0x1828ED470
	...
	// RVA: 0x28EBCF0 Offset: 0x28EA6F0 VA: 0x1828EBCF0
	public int2 get_yz() { }

	// RVA: 0x28ED710 Offset: 0x28EC110 VA: 0x1828ED710
	public void set_yz(int2 value) { }

	// RVA: 0x28EB540 Offset: 0x28E9F40 VA: 0x1828EB540
	public int2 get_yw() { }

	// RVA: 0x28ED5F0 Offset: 0x28EBFF0 VA: 0x1828ED5F0
	public void set_yw(int2 value) { }

	// RVA: 0x28EC210 Offset: 0x28EAC10 VA: 0x1828EC210
	public int2 get_zx() { }

	// RVA: 0x28ED820 Offset: 0x28EC220 VA: 0x1828ED820
	public void set_zx(int2 value) { }

	// RVA: 0x28EC4B0 Offset: 0x28EAEB0 VA: 0x1828EC4B0
	public int2 get_zy() { }

	// RVA: 0x28ED8B0 Offset: 0x28EC2B0 VA: 0x1828ED8B0
	public void set_zy(int2 value) { }

	// RVA: 0x28EC750 Offset: 0x28EB150 VA: 0x1828EC750
	public int2 get_zz() { }
	...
	// RVA: 0x28EA3A0 Offset: 0x28E8DA0 VA: 0x1828EA3A0
	public int2 get_wx() { }

	// RVA: 0x28ED2C0 Offset: 0x28EBCC0 VA: 0x1828ED2C0
	public void set_wx(int2 value) { }

	// RVA: 0x28EA640 Offset: 0x28E9040 VA: 0x1828EA640
	public int2 get_wy() { }

	// RVA: 0x28ED350 Offset: 0x28EBD50 VA: 0x1828ED350
	public void set_wy(int2 value) { }

	// RVA: 0x28EA8E0 Offset: 0x28E92E0 VA: 0x1828EA8E0
	public int2 get_wz() { }

	// RVA: 0x28ED3E0 Offset: 0x28EBDE0 VA: 0x1828ED3E0
	public void set_wz(int2 value) { }

	// RVA: 0x28EA110 Offset: 0x28E8B10 VA: 0x1828EA110
	public int2 get_ww() { }
	...
	// RVA: 0x1C63A10 Offset: 0x1C62410 VA: 0x181C63A10 Slot: 4
	public bool Equals(int4 rhs) { }

	// RVA: 0x2966E50 Offset: 0x2965850 VA: 0x182966E50 Slot: 0
	public override bool Equals(object o) { }

	// RVA: 0x28A2D50 Offset: 0x28A1750 VA: 0x1828A2D50 Slot: 2
	public override int GetHashCode() { }

	// RVA: 0x2966F00 Offset: 0x2965900 VA: 0x182966F00 Slot: 3
	public override string ToString() { }

	// RVA: 0x2967110 Offset: 0x2965B10 VA: 0x182967110 Slot: 5
