internal interface IFileSaveDialog : IFileDialog, IModalWindow // TypeDefIndex: 17331
{
	// Methods
	...
	public abstract void SetSaveAsItem([In] IShellItem psi);

	// RVA: -1 Offset: -1 Slot: 25
	public abstract void SetProperties([In] IntPtr pStore);

	// RVA: -1 Offset: -1 Slot: 26
	public abstract void SetCollectedProperties([In] IntPtr pList, [In] int fAppendDefault);

	// RVA: -1 Offset: -1 Slot: 27
	public abstract void GetProperties(out IntPtr ppStore);

	// RVA: -1 Offset: -1 Slot: 28
	public abstract void ApplyProperties([In] IShellItem psi, [In] IntPtr pStore, in IntPtr hwnd, [In] IntPtr pSink);
}
