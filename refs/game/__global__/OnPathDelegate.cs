public sealed class OnPathDelegate : MulticastDelegate // TypeDefIndex: 13126
{
	// Methods
	...
	public virtual void Invoke(Path p) { }

	// RVA: 0x593400 Offset: 0x591E00 VA: 0x180593400 Slot: 14
	public virtual IAsyncResult BeginInvoke(Path p, AsyncCallback callback, object object) { }
