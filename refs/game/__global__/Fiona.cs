public class Fiona : NPC // TypeDefIndex: 1700
{
	// Fields
	public ShopInterface ShopInterface; // 0x2F0
	[Header("Settings")]
	public string[] OrderCompletedLines; // 0x2F8
	private bool NetworkInitialize___EarlyScheduleOne.NPCs.CharacterClasses.FionaAssembly-CSharp.dll_Excuted; // 0x300
	private bool NetworkInitialize__LateScheduleOne.NPCs.CharacterClasses.FionaAssembly-CSharp.dll_Excuted; // 0x301

	// Methods

	// RVA: 0x71AA90 Offset: 0x719490 VA: 0x18071AA90 Slot: 71
	protected override void Start() { }

	// RVA: 0x71A9B0 Offset: 0x7193B0 VA: 0x18071A9B0
	private void OrderCompleted() { }

	// RVA: 0x71AA40 Offset: 0x719440 VA: 0x18071AA40
