...
public sealed class NPCRelationship
{
	...
	internal NPCRelationData Component
	{
		get
		{
			NPC nPC = NPC;
			...
			{
				NPC s1NPC = nPC.S1NPC;
				result = ((s1NPC != null) ? s1NPC.RelationData : null);
			}
			return (NPCRelationData)result;
		}
	}
	...
	public event Action<float> OnChanged
	{
		add
		{
			...
			try
			{
				...
				Delegate value3 = Delegate.Combine((Delegate)((value2 is Delegate) ? value2 : null), (Delegate)action);
		...
		remove
		{
			...
			try
			{
				...
				if (!(field == null))
				{
					...
					Delegate value4 = ((value3 != null) ? Delegate.Remove((Delegate)((value3 is Delegate) ? value3 : null), (Delegate)value2) : null);
