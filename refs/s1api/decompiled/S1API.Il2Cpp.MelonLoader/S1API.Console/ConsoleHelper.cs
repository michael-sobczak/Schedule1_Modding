...
public static class ConsoleHelper
{
	...
	public static void AddItemToInventory(string itemCode, int? quantity = null)
	{
		...
		{
			val2.Add(quantity.Value.ToString());
		}
		((ConsoleCommand)val).Execute(val2);
	}
	...
	public static void SetPlayerEnergyLevel(float amount)
	{
		...
		List<string> val2 = new List<string>();
		val2.Add(amount.ToString(CultureInfo.InvariantCulture));
		((ConsoleCommand)val).Execute(val2);
	}
	...
	public static void SetPlayerJumpMultiplier(float multiplier)
	{
		...
		List<string> val2 = new List<string>();
		val2.Add(multiplier.ToString(CultureInfo.InvariantCulture));
		((ConsoleCommand)val).Execute(val2);
	}
	...
	public static void SetLawIntensity(float intensity)
	{
		...
		List<string> val2 = new List<string>();
		val2.Add(intensity.ToString(CultureInfo.InvariantCulture));
		((ConsoleCommand)val).Execute(val2);
	}
	...
	public static void SetNpcRelationship(string npcId, float level)
	{
		...
		List<string> val2 = new List<string>();
		val2.Add(npcId);
		val2.Add(level.ToString(CultureInfo.InvariantCulture));
		((ConsoleCommand)val).Execute(val2);
	}
