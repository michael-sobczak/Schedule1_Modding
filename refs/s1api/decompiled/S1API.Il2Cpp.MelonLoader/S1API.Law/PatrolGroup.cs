...
public sealed class PatrolGroup
{
	...
	public int MemberCount
	{
		get
		{
			...
			return (s1PatrolGroup != null) ? s1PatrolGroup.Members.Count : 0;
		}
	}
	...
	public int CurrentWaypoint
	{
		...
		{
			PatrolGroup s1PatrolGroup = S1PatrolGroup;
			return (s1PatrolGroup != null) ? s1PatrolGroup.CurrentWaypoint : 0;
		}
	}
	...
	public FootPatrolRoute Route
	{
		...
		{
			PatrolGroup s1PatrolGroup = S1PatrolGroup;
			if ((Object)(object)((s1PatrolGroup != null) ? s1PatrolGroup.Route : null) == (Object)null)
			{
				return null;
			}
