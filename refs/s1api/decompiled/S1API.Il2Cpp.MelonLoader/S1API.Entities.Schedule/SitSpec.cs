...
public sealed class SitSpec : IScheduleActionSpec
{
	...
	void IScheduleActionSpec.ApplyTo(NPCSchedule schedule)
	{
		...
		if (!((Object)(object)val == (Object)null))
		{
			...
			{
				string value = (((Object)(object)schedule.NPC?.gameObject != (Object)null) ? ((Object)schedule.NPC.gameObject).name : "Unknown");
				Debug.LogWarning(Object.op_Implicit($"[S1API] SitSpec could not resolve a seat set (Name={SeatSetName}, Path={SeatSetPath}) for NPC '{value}'."));
			}
	...
	private AvatarSeatSet[] FindAllSeatSets()
	{
		try
		{
			return Il2CppArrayBase<AvatarSeatSet>.op_Implicit(Object.FindObjectsOfType<AvatarSeatSet>(IncludeInactiveSearch));
		}
		catch
		{
