...
public class NPCAppearance
{
	...
	private static IEnumerator ProcessMugshotQueue()
	{
		while (true)
		{
			...
			next.NPC.S1NPC.Avatar.GetMugshot((Action<Texture2D>)delegate(Texture2D generatedMugshot)
			{
	...
	private static void UpdatePoiIcons(NPC npc, Sprite iconSprite)
	{
		...
		try
		{
			NPCPoI[] array = Object.FindObjectsOfType<NPCPoI>();
			NPCPoI[] array2 = array;
			foreach (NPCPoI val in array2)
			{
				if (!((Object)(object)val.NPC == (Object)(object)npc) || !((Object)(object)((POI)val).IconContainer != (Object)null))
				{
					continue;
				}
				Transform val2 = ((Transform)((POI)val).IconContainer).Find("Outline/Icon");
				if ((Object)(object)val2 != (Object)null)
				{
