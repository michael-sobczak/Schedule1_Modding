...
public sealed class NPCSchedule
{
	...
	internal T AddActionInternal<T>(int startTime, string name = null) where T : NPCAction
	{
		...
		T[] componentsInChildren = ((Component)Manager).GetComponentsInChildren<T>(true);
		T val = default(T);
		...
		if ((Object)(object)val == (Object)null)
		{
			...
			{
				Debug.LogWarning((object)("[S1API] No available pre-created actions of type " + typeof(T).Name + ". Add more via NPC.ConfigurePrefab."));
				return default(T);
			}
	...
	public void EnsureDealSignal()
	{
		...
		{
			Debug.LogWarning((object)"[S1API] DealSignal missing on prefab. Please add via NPC.ConfigurePrefab(builder.EnsureDealSignal()).");
		}
	}
	...
	public void ClearActions(bool includeSignals = true, bool includeEvents = true)
	{
		...
		NPCAction[] componentsInChildren = ((Component)Manager).GetComponentsInChildren<NPCAction>(true);
		NPCAction[] array = componentsInChildren;
		foreach (NPCAction val in array)
		{
			bool flag = val is NPCSignal;
			bool flag2 = val is NPCEvent;
			if (((flag && includeSignals) || (flag2 && includeEvents)) && (Object)(object)val != (Object)null && (Object)(object)((Component)val).gameObject != (Object)null)
			{
	...
	internal void EnsureManager()
	{
		...
		if ((Object)(object)componentInChildren == (Object)null)
		{
			Debug.LogWarning((object)"[S1API] NPCScheduleManager is missing. Ensure it is added in NPC.ConfigurePrefab.");
		}
	}
